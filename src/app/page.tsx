            ...
            <div className="flex items-stretch">
                ...
                <div className="relative w-32 md:w-48 lg:w-64 flex-shrink-0 overflow-hidden hidden md:block">
                    <video 
                        ...
                        className="absolute inset-0 w-full h-full object-cover opacity-50 rotate-90 scale-150"
                    >
        ...
        <div className="relative">
            <div className="absolute inset-0 z-0 opacity-[0.04] pointer-events-none">
                <video 
                    ...
                    muted 
                    playsInline 
                    className="w-full h-full object-cover sticky top-0 rotate-90 scale-[1.8]"
                >
                    <source src="https://res.cloudinary.com/dkits80xk/video/upload/v1778683152/hero-animation_gep3ir.mp4" type="video/mp4" />
                </video>
            </div>
